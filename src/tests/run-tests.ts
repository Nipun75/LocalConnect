// Standalone test runner for LocalConnect AI Intelligence Layer

import { LocalDeterministicProvider } from '../services/ai/LocalDeterministicProvider';
import { rankProviders } from '../services/matching/matchingEngine';
...
export async function runTests() {
  ...
  assert(trustRes.total_score >= 95, `Priya trust score is ${trustRes.total_score}/100`);
